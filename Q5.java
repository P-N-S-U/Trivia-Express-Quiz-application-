...
public class Q5 implements ActionListener{
    ...
    JTextField Question = new JTextField("Which of the following is not a measure of Human Development Index?");
    JButton o1 = new JButton("Life Expectancy");                           
    JButton o2 = new JButton("Sex Ratio");
    JButton o3 = new JButton("Literacy Rate");
    JButton o4 = new JButton("Gross Enrolment");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Ratio of men:women in a Country", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
        ...
        Question.setFont(new Font(Font.MONOSPACED, Font.BOLD, 25));
