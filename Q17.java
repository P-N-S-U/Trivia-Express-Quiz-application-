...
public class Q17 implements ActionListener{
    frame f = new frame();
    ...
    JTextField Question = new JTextField("Which countrys national football team has won the FIFA Football World Cup most number of times?");
    JButton o1 = new JButton("Spain");                           
    JButton o2 = new JButton("Argentina");
    JButton o3 = new JButton("Germany");
    JButton o4 = new JButton("Brazil");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Christ the Redeemer (Statue of Jesus)", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
