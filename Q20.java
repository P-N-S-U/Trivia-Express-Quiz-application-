...
public class Q20 implements ActionListener{
    frame f = new frame();
    ...
    JTextField Question = new JTextField("Blind Valley is found in ");
    JButton o1 = new JButton("Karst Region");                           
    JButton o2 = new JButton("Dry Region");
    JButton o3 = new JButton("Icy Region");
    JButton o4 = new JButton("Tundra Region");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Geographical and cultural region located in southeastern europe", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
        ...
        o1.setFont(new Font(Font.MONOSPACED, Font.ITALIC, 50));
        ...
        o2.setFont(new Font(Font.MONOSPACED, Font.ITALIC, 50));
        ...
        o3.setFont(new Font(Font.MONOSPACED, Font.ITALIC, 50));
        ...
        o4.setFont(new Font(Font.MONOSPACED, Font.ITALIC, 50));
    ...
    public void actionPerformed(ActionEvent e) {                                    
        ...
        if(e.getSource()==o1){
            ...
            a.SCORE(scoreHolder, scoreHolderfun);
