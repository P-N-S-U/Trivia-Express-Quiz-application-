...
public class Q3 implements ActionListener{
    ...
    JTextField Question = new JTextField("How many calories are gained by drinking a glass of water? ");
    JButton o1 = new JButton("Zero");                           
    JButton o2 = new JButton("15 cal");
    JButton o3 = new JButton("25 cal");
    JButton o4 = new JButton("50 cal");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Stay hydrated without adding extra calories", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
    ...
    @Override                                                       //make changes here for correct option and score and object of next question
