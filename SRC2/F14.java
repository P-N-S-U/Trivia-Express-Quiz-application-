...
public class F14 implements KeyListener{
    frame f = new frame();
    ...
    public void Questions(ScoreHolderfun scoreHolderfun){
        ...
        T.append("I'm essential for the formation of organic molecules in living organisms. What am I?");
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Element number 6 atomic weight 12", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));
            }
            @Override
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(e.getKeyCode()==10){
            ...
            if(Answer.equals("carbon")||Answer.equals("Carbon")){
                SCORE+=25;
                scoreHolderfun.setScore(SCORE);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));
                f.dispose();
