...
public class F3 implements KeyListener{
    frame f = new frame();
    ...
    public void Questions(ScoreHolderfun scoreHolderfun){
        ...
        T.append("What begins with an 'e' and only contains one letter?");
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "You might use it to send a love-letter!!","HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));
            }
            @Override
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(e.getKeyCode()==10){
            ...
            if(Answer.equals("Envelope")||Answer.equals("envelope")){
                SCORE+=25;
                scoreHolderfun.setScore(SCORE);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));
                f.dispose();
