...
public class F6 implements KeyListener{
    frame f = new frame();
    ...
    public void Questions(ScoreHolderfun scoreHolderfun){
        ...
        T.append("I'm tall when I'm young, and I'm short when I'm old. What am I?");
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Made of wax and emits light", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));
            }
            @Override
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(e.getKeyCode()==10){
            ...
            if(Answer.equals("Candle")||Answer.equals("candle")){
                SCORE+=25;
                scoreHolderfun.setScore(SCORE);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));
                f.dispose();
