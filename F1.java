...
public class F1 implements KeyListener{
    ...
    public void Questions(ScoreHolderfun scoreHolderfun){
        ...
        T.append("What 4-letter word can be written forward,backward or \nupside down,and can still be read from left to right?");
        T.setBackground(new Color(56, 182, 255));
        T.setBorder(BorderFactory.createTitledBorder("QUESTION"));
        T.setFont(new Font(Font.MONOSPACED, Font.BOLD, 30));
        T.setEditable(false);
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "The word consists of 'oo' in it", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));
            }
            @Override
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(e.getKeyCode()==10){
            ...
            if(Answer.equals("Noon")||Answer.equals("noon")){
                SCORE+=25;
                scoreHolderfun.setScore(SCORE);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));
                f.dispose();
