...
public class F9 implements KeyListener{
    frame f = new frame();
    ...
    public void Questions(ScoreHolderfun scoreHolderfun){
        ...
        T.append("If there are three apples and you take away two,\nhow many apples do you have?");
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "0 + 2 = 2", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));
            }
            @Override
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(e.getKeyCode()==10){
            ...
            if(Answer.equals("two")||Answer.equals("2")){
                SCORE+=25;
                scoreHolderfun.setScore(SCORE);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));   
                f.dispose();            
