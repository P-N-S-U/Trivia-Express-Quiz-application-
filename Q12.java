...
public class Q12 implements ActionListener{
    frame f = new frame();
    ...
    JTextField Question = new JTextField("Tsunami word belongs to which of the following languages? ");
    JButton o1 = new JButton("Arabic");                           
    JButton o2 = new JButton("Japanese");
    JButton o3 = new JButton("Hebrew");
    JButton o4 = new JButton("Latin");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Popular for its anime and Mt.Fuji", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
