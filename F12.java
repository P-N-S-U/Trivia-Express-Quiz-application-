...
public class F12 implements KeyListener{
    frame f = new frame();
    ...
    public void Questions(ScoreHolderfun scoreHolderfun){
        ...
        T.append("I have keys but open no locks. I have space but no room. \nYou can enter, but you can't go inside. What am I?");
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Speaks QWERTY language!!", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));
            }
            @Override
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(e.getKeyCode()==10){
            ...
            if(Answer.equals("Keyboard")||Answer.equals("keyboard")){
                SCORE+=25;
                scoreHolderfun.setScore(SCORE);
                t1.setText(Integer.toString(scoreHolderfun.getScore()));               
                f.dispose();
