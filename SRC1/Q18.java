...
public class Q18 implements ActionListener{
    frame f = new frame();
    ...
    JTextField Question = new JTextField("India won its first-ever medal in which sport in the Commonwealth Games 2022?");
    JButton o1 = new JButton("Netball");                           
    JButton o2 = new JButton("Squash");
    JButton o3 = new JButton("Lawn bowls");
    JButton o4 = new JButton("Rugby sevens");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "sports played on grass or synthetic surface called bowling green", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
        ...
        Question.setFont(new Font(Font.MONOSPACED, Font.BOLD, 20));
