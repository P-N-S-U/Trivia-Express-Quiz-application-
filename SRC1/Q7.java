...
public class Q7 implements ActionListener{
    ...
    JTextField Question = new JTextField("In India, life expectancy is?");
    JButton o1 = new JButton("68.8 years ");                           
    JButton o2 = new JButton("71.2 years");
    JButton o3 = new JButton("75.5 years");
    JButton o4 = new JButton("65.3 years");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "some demo HINT", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
