...
public class Q4 implements ActionListener{
    ...
    JTextField Question = new JTextField("Human eye is most sensitive to visible light of the wavelength?");
    JButton o1 = new JButton("6050 Å");                           
    JButton o2 = new JButton("5500 Å");
    JButton o3 = new JButton("4500 Å");
    JButton o4 = new JButton("7500 Å");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "550 nm", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
