...
public class Q15 implements ActionListener{
    ...
    JTextField Question = new JTextField("Which of the following is not a type of financial market?");
    JButton o1 = new JButton("Capital market");                           
    JButton o2 = new JButton("Money market");
    JButton o3 = new JButton("Gold market");
    JButton o4 = new JButton("Insurance market");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "plays a vital role in implementation of monetary policy in central bank", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
