...
public class Q11 implements ActionListener{
    frame f = new frame();
    ...
    JTextField Question = new JTextField("Point of intersection of Equator and the prime Meridian is located at?");
    JButton o1 = new JButton("Atlantic Ocean");                           
    JButton o2 = new JButton("Ghana");
    JButton o3 = new JButton("Morocco");
    JButton o4 = new JButton("Pacific Ocean");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "gulf of Guinea off the coast of africa", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
        ...
        Question.setFont(new Font(Font.MONOSPACED, Font.BOLD, 24));
        ...
        o1.setFont(new Font(Font.MONOSPACED, Font.ITALIC, 45));
        ...
        o2.setFont(new Font(Font.MONOSPACED, Font.ITALIC, 45));
        ...
        o3.setFont(new Font(Font.MONOSPACED, Font.ITALIC, 45));
        ...
        o4.setFont(new Font(Font.MONOSPACED, Font.ITALIC, 45));
    ...
    @Override                                                       //make changes here for correct option/score/color and next question oject 
