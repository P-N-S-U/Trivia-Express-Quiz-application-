...
public class Q19 implements ActionListener{
    frame f = new frame();
    ...
    JTextField Question = new JTextField("Your bank card can complete which type of transaction that makes money out of your checking account.");
    JButton o1 = new JButton("Credit");                           
    JButton o2 = new JButton("Transit");
    JButton o3 = new JButton("Debit");
    JButton o4 = new JButton("Lien");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "reduction or subtraction of funds from an individual's or organization's account", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
        ...
        Question.setFont(new Font(Font.MONOSPACED, Font.BOLD, 17));
