...
public class Q14 implements ActionListener{
    frame f = new frame();
    ...
    JTextField Question = new JTextField("The first country to adopt a crypto currency as legal tender");
    JButton o1 = new JButton("Luxemborg");                           
    JButton o2 = new JButton("Mexico");
    JButton o3 = new JButton("Qatar");
    JButton o4 = new JButton("el Salvador");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Country located in central America having official language as Spanish", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
