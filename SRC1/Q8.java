...
public class Q8 implements ActionListener{
    ...
    JTextField Question = new JTextField("The normal temperature of the human body is?");
    JButton o1 = new JButton("37ºC ");                           
    JButton o2 = new JButton("98ºC");
    JButton o3 = new JButton("367 K ");
    JButton o4 = new JButton("None of above");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "98.6 F", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
