...
public class Q16 implements ActionListener{
    ...
    JTextField Question = new JTextField("Who among the following is the first Indian to score a century in IPL?");
    JButton o1 = new JButton("Gautam Gambhir");                           
    JButton o2 = new JButton("Manish Pandey");
    JButton o3 = new JButton("Sachin");
    JButton o4 = new JButton("Rahul Dravid");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Number 19 of rcb(in 2009)", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
