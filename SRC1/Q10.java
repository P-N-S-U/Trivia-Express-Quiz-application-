...
public class Q10 implements ActionListener{
    ...
    JTextField Question = new JTextField("Who gave the theory of gravity? ");
    JButton o1 = new JButton("Charles Newton");                           
    JButton o2 = new JButton("Charles Babbage");
    JButton o3 = new JButton("Isaac Newton");
    JButton o4 = new JButton("Albert Einstine");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "SI unit of Force", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
