...
public class Q9 implements ActionListener {
    ...
    JTextField Question = new JTextField("Percentage of nitrogen in dry air?");
    JButton o1 = new JButton("21%");                           
    JButton o2 = new JButton("50%");
    JButton o3 = new JButton("78%");
    JButton o4 = new JButton("73%");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Most abundant Gas in atmoshphere", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
