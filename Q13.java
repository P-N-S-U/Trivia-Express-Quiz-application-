...
public class Q13 implements ActionListener{
    frame f = new frame();
    ...
    JTextField Question = new JTextField("The most abundant gas emitted from volcanoes is ");
    JButton o1 = new JButton("Helium");                           
    JButton o2 = new JButton("Sulphur Dioxide");
    JButton o3 = new JButton("Carbon Dioxide");
    JButton o4 = new JButton("Water Vapour");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {                 //for hint cost = -20
                ...
                JOptionPane.showMessageDialog(null, "Steam", "HINT", 2, hintIcon);
                t1.setText(Integer.toString(scoreHolder.getScore()));
            }
            @Override
