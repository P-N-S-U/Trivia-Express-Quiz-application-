...
public class Q1 implements ActionListener{
    ...
    JButton o1 = new JButton("Aluminium");                           
    JButton o2 = new JButton("Iron");
    JButton o3 = new JButton("Oxygen");
    JButton o4 = new JButton("Silicon");
    ...
    public void Questions(ScoreHolder scoreHolder){
        ...
        JTextField Question = new JTextField("Chemical element found in abundance in the Earths crust is?");
        ...
        hint.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                ...
                JOptionPane.showMessageDialog(null, "cruicial for sustaining life and Combustion..", "HINT", 2, hintIcon);
            }
            @Override
